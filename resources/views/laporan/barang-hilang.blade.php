...
<body>
    ...
    <table class="info-table">
        ...
        <tr>
            <td><strong>Total Barang Hilang</strong></td>
    ...
    @if ($barangs->count() > 0)
        <div class="alert">
            <strong>Perhatian:</strong> Terdapat {{ $barangs->count() }} item barang dengan status HILANG yang perlu
            dilakukan investigasi dan pelaporan.
        </div>

        <h3 style="margin-top: 30px;">Daftar Barang Hilang</h3>
        ...
        <h3 style="margin-top: 30px;">Tindak Lanjut yang Diperlukan</h3>
        <ol>
            <li>Lakukan investigasi mendalam terhadap kehilangan barang</li>
            <li>Periksa log aktivitas dan transaksi terkait barang hilang</li>
            <li>Dokumentasikan kronologi kehilangan barang</li>
            <li>Buat laporan kehilangan kepada pihak berwenang jika diperlukan</li>
            <li>Ajukan klaim asuransi atau penggantian sesuai prosedur</li>
            <li>Evaluasi sistem keamanan dan pengawasan inventaris</li>
        </ol>
    @else
        <div class="alert">
            <strong>Informasi:</strong> Tidak ada barang dengan status HILANG pada periode yang dipilih. Semua barang
            inventaris tercatat dengan baik.
        </div>
    @endif
