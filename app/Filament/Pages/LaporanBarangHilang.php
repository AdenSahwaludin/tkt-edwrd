...
class LaporanBarangHilang extends Page implements HasForms
{
    ...
    protected static ?string $title = 'Laporan Barang Hilang';

    protected static string|UnitEnum|null $navigationGroup = 'Laporan';

    protected static ?int $navigationSort = 3;

    protected string $view = 'filament.pages.laporan-barang-hilang';
